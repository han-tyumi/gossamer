...
export const from_length: typeof $float64Array.from_length = (length) =>
  new Float64Array(Math.max(0, length));
...
export const from_buffer: typeof $float64Array.from_buffer = (buffer) =>
  checkBufferAligned(buffer, 8, () => new Float64Array(buffer));

export const from_buffer_range: typeof $float64Array.from_buffer_range = (
  buffer,
  byteOffset,
  length,
) =>
...
export const bytes: typeof $float64Array.bytes = (array) =>
...
export const set: typeof $float64Array.set = (array, values, offset) =>

import type * as $int32Array from "$/gossamer/gossamer/buffer/int32_array.mjs";
import {
  checkArrayRange,
  checkBufferAligned,
...
export const from_buffer: typeof $int32Array.from_buffer = (buffer) =>
  checkBufferAligned(buffer, 4, () => new Int32Array(buffer));

export const from_buffer_range: typeof $int32Array.from_buffer_range = (
  buffer,
  byteOffset,
  length,
) =>
...
export const bytes: typeof $int32Array.bytes = (array) =>
...
export const set: typeof $int32Array.set = (array, values, offset) =>

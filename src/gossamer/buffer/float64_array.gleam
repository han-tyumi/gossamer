...
pub fn bytes(array: Float64Array) -> Uint8Array
...
pub fn byte_offset(array: Float64Array) -> Int

@external(javascript, "./float64_array.ffi.mjs", "length")
pub fn length(array: Float64Array) -> Int

...
//// `gossamer/url` exposes the WHATWG URL parser, which validates that the
//// input is an absolute URL and returns it in canonical form: the host
//// lowercased, default ports dropped, `.` and `..` path segments resolved,

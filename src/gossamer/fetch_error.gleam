//// The error type for [`fetch_extra`](./fetch_extra.html). Supersedes
...
/// Errors raised by `fetch_extra`. Mirrors `gleam_fetch.FetchError`'s
/// NetworkError / UnableToReadBody / InvalidJsonBody variants and adds
/// `Aborted` for bindings that accept an `AbortSignal`.
///
pub type FetchError {
